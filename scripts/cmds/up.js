...
module.exports = {
    config: {
        ...
        aliases: ["uptime", "upt"],
        version: "1.2",
        author: "Xaiko-Jisan",//**you needed my cmd but don't share this cmd***and original author fb I'd : https://www.facebook.com/XAIKO.JISAN?mibextid=ZbWKwL **//
        countDown: 5,
        role: 0,
        shortDescription: {
            en: ""
    ...
    onStart: async function ({ message, event, args, api, usersData, threadsData }) {
        const iURL = "https://i.imgur.com/LFHaxoq.jpeg"; //**photo link to fixed don't change photo link okay bro**//
